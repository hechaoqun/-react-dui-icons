...
const CardFill = props => {
  ...
  return (
    ...
    >
      ...
      <path d="M13.286 4.929c0-1.066.863-1.929 1.928-1.929h3.857C20.137 3 21 3.863 21 4.929v3.857a1.929 1.929 0 01-1.929 1.928h-3.857a1.929 1.929 0 01-1.928-1.928V4.929z"></path>
